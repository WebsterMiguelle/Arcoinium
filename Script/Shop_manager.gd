...
var all_cards = [
	{"id": 0, "name": "Solar Coin", "rank": "B", "desc": "The 1st and 3rd Coin Flip are always SUN."},
	{"id": 1, "name": "Lunar Coin", "rank": "B", "desc": "The 2nd and 4th Coin Flip are always MOON."},
	...
	{"id": 9, "name": "Simple Interest", "rank": "B", "desc": "For each RESERVED Coin removed, apply 1 GAIN to self."},
