...
var all_cards = [
	...
	{"id": 10, "name": "Simple Interest", "rank": "B", "desc": "For each Reserved Coin removed, apply 1 Gain to self."},
	...
	{"id": 18, "name": "Payback", "rank": "A", "desc": " If Coin Caster receives a killing blow, set Coin back to 1, Apply 16 THRIFT to the Enemy, and immediately generate 8 Gold Sun Coins next turn. (One-Time per Battle)"},
	{"id": 19, "name": "Loan Shark", "rank": "A", "desc": "At the start of the enemy’s turn, immediately deal damage based on half of the Enemy’s DEBT. Remove triggered DEBT afterwards."},
	...
	{"id": 25, "name": "Refund", "rank": "S", "desc": "+1 Extra Re-Flip. There is a 20% chance to retrieve all coins from the Arcane Circle upon a Re-Flip. If Successful, apply 4 THRIFT to Enemy."},
