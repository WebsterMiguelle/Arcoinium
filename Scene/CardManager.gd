...
var all_cards = [
	...
	{"id": 24, "name": "Bankrupt", "rank": "S", "desc": "For each turn, apply 8 DEBT, 4 SPEND, and 2 THRIFT. If Enemy DEBT is greater than their Current Coins at the end of their turn, perish instantly."},
