...
var all_cards = [
	...
	{"id": 4, "name": "Merchant's Scroll", "rank": "B", "desc": "The Shopkeeper accompanies you. When you receive Damage, she gains a Turn and flips 1 STAMPED COPPER MOON-SUN Pair. Max Coin Flip increases by 2 each succeeding turn."},
	...
	{"id": 10, "name": "Simple Interest", "rank": "B", "desc": "For each MOON-MOON Pair played, 1 Moon Coin becomes SHINED at the end of the turn."},

	{"id": 11, "name": "Gold Rush", "rank": "A", "desc": "+10% Gold Flip Rate. For each SUN-SUN Pair played, 1 SUN Coin is Upgraded to Gold. Upgrading beyond Gold becomes SHINED."},
	...
	{"id": 27, "name": "Deposit", "rank": "A", "desc": "Max Reserve +4. RESERVING a Coin applies 1 GAIN. Statused Coins apply 3 GAIN instead."},
